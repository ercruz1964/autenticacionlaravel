  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{request()->routeIs('tipoafiliacion.index')? 'active' : ''}}" href="{{route('tipoafiliacion.index')}}">Tipo Afiliacion</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{request()->routeIs('sexo')? 'active' : ''}}" href="{{route('sexo.index')}}">Generos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{request()->routeIs('tipodocumento')? 'active' : ''}}" href="{{route('tipodocumento.index')}}">Tipo de Document</a>
        </li>
        @guest
        <li class="nav-item">
          <a class="nav-link {{request()->routeIs('registrar')? 'active' : ''}}" href="{{route('registrar.create')}}">Registrar</a>
        </li>
        <li class="nav-item">
